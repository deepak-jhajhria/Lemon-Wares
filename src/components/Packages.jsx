...
const Packages = () => {
  ...
  function tabchange(tabs) {
    ...
    <div className='container max-w-[1120px] flex flex-col mt-12 sm:mt-16 md:mt-20 lg:mt-[93px]'>
      <div className='flex flex-col max-w-[856px] mx-auto'>
        ...
        <div className='flex items-center w-full relative after:absolute after:bg-[#C4C4C4] after:w-full after:h-[2px] sm:after:h-1 after:-bottom-[6px] after:left-0'>
      ...
      {
        first === "tab1" && <div className='grid lg:grid-cols-3 mt-10 sm:mt-16 md:mt-20 gap-7 lg:gap-0'>
          {
                ...
                <div className='p-[34px]'>
                  ...
                  <div className='flex flex-col sm:flex-row lg:flex-col justify-between sm:justify-around lg:justify-start'>
                    ...
                    <div>
                      ...
                      <p className='flex items-center text-[#808080] text-sm sm:text-base font-Inter font-semibold gap-4 sm:gap-6 mt-[15px]'><span><RightIcon /></span>Softaculous</p>
                    </div>
                  </div>
                </div>
              </div>
